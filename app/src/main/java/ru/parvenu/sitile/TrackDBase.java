...
public class TrackDBase {
    private static TrackDBase sTrackBase;
    private Context mContext;
    private SQLiteDatabase mDatabase;

    public static TrackDBase get(Context context) {
        if (sTrackBase == null) {
            sTrackBase = new TrackDBase(context);
        }
        return sTrackBase;
    }

    private TrackDBase(Context context) {
